// Vendored verbatim from OpenVibe.VIP client/vip-client.js at 2accbeb (openvibe-vip/client). Replace
// with the pinned package (require('openvibe-vip/client')) once OpenVibe.VIP publishes a tag; do not edit here.
'use strict';
