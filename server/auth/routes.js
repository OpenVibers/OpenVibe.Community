...
// ═══════════════════════════════════════════════════════════════
// openvibe.community — OAuth2 CLIENT session layer
//
// The identity provider is OpenVibe.Network (https://openvibe.network).
// This site is registered there as OAuth client `community`, redirect
// https://openvibe.community/auth/callback. Same shape as the Tools gateway.
//
...
//
// Cookies (all host-only — openvibe.community has no subdomains):
